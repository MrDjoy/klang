...
class TradingPlan(Base):
    ...
    buy_price = Column(Float(precision=10, decimal_return_scale=4), nullable=False)
    stop_loss_price = Column(Float(precision=10, decimal_return_scale=4), nullable=False)
    take_profit_price = Column(Float(precision=10, decimal_return_scale=4), nullable=False)
    quantity = Column(Integer, nullable=False)
    threshold = Column(Float(precision=5, decimal_return_scale=4), default=0.01)
    date_up_rate = Column(Float(precision=5, decimal_return_scale=4), default=0.03)
    date_down_rate = Column(Float(precision=5, decimal_return_scale=4), default=0.04)
    total_down_rate = Column(Float(precision=5, decimal_return_scale=4), default=0.04)
...
class ExecutionLog(Base):
    ...
    latest_price = Column(Float(precision=10, decimal_return_scale=4))
    open_price = Column(Float(precision=10, decimal_return_scale=4))
    high_price = Column(Float(precision=10, decimal_return_scale=4))
    low_price = Column(Float(precision=10, decimal_return_scale=4))
