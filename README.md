...
### 引用函数
   ...
   * BARSSINCE,BARSSINCEN,CALCSTOCKINDEX,CURRBARSCOUNT


#### 未实现列表
   * EXTERNSTR,EXTERNVALUE,SIGNALS\_USER,BARSTATUS,CONST
...
# 更新
* 2022.10.19 server 换成socket.io通讯协议
* 2022.10.17 全面采取了分片执行，真正实现了多服务器并行工作
* 2021.12.1 增加了特征提取公式
